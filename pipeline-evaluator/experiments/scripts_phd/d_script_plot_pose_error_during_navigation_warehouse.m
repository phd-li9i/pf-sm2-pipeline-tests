...
colours_h2 = [0,0,0; 228,26,28; 55,126,184; 77,175,74]/255;
colours_h3 = [0,0,0; 102,194,165; 252,141,98; 141,160,203]/255;
linewidth = 2;

figure(1, 'position', [1 1 250 200])
hold on
plot(errors_h1{1}, 'color', [colours_h2(1,:)]);
plot(errors_h1{2}, 'color', [colours_h2(2,:)]);
plot(errors_h1{3}, 'color', [colours_h2(3,:)]);
plot(errors_h1{4}, 'color', [colours_h2(4,:)]);

img_file_h1 = strcat(save_eps_path, map_name, '_h1.eps');
drawnow ("epslatex", img_file_h1, false)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(2, 'position', [1 1 500 500])
subplot(2,2,1)
hold on
plot(errors_h2{1}, 'color', [colours_h2(1,:)], 'linewidth', linewidth);
plot(errors_h2{5}, 'color', 'k', 'linewidth', linewidth);
box on
xlim([0 400])
ylim([0 0.10])
set(gca, 'xtick', [0 100 200 300 400], {'$0$','$100$','$200$','$300$','$400$','$500$'});
set(gca, 'ytick', [0.0 0.02 0.04 0.06 0.08 0.10], {'$0$','$0.02$','$0.04$','$0.06$','$0.08$','$0.10$'});

subplot(2,2,2)
hold on
plot(errors_h2{2}, 'color', [colours_h2(2,:)], 'linewidth', linewidth);
plot(errors_h2{6}, 'color', 'k', 'linewidth', linewidth);
box on
xlim([0 400])
ylim([0 0.10])
set(gca, 'xtick', [0 100 200 300 400], {'$0$','$100$','$200$','$300$','$400$','$500$'});
...
subplot(2,2,3)
hold on
plot(errors_h2{3}, 'color', [colours_h2(3,:)], 'linewidth', linewidth);
plot(errors_h2{7}, 'color', 'k', 'linewidth', linewidth);
box on
xlim([0 400])
ylim([0 0.10])
set(gca, 'xtick', [0 100 200 300 400], {'$0$','$100$','$200$','$300$','$400$','$500$'});
...
xlim([0 400])
ylim([0 0.15])
plot(errors_h2{4}, 'color', [colours_h2(4,:)], 'linewidth', linewidth);
plot(errors_h2{8}, 'color', 'k', 'linewidth', linewidth);
box on
set(gca, 'xtick', [0 100 200 300 400], {'$0$','$100$','$200$','$300$','$400$','$500$'});
set(gca, 'ytick', [0.0 0.03 0.06 0.09 0.12 0.15], {'$0$','$0.03$','$0.06$','$0.09$','$0.12$','$0.15$'});

xlabel('Αριθμός εκτιμήσεων στάσης στο χρόνο')
ylabel('Μέσο σφάλμα εκτίμησης στάσης ανά εκτιμώμενη στάση')
img_file_h2 = strcat(save_eps_path, map_name, '_h2.eps');
...
plot(errors_h3{2}, 'color', [colours_h3(2,:)], 'linewidth', linewidth);
plot(errors_h3{3}, 'color', [colours_h3(3,:)], 'linewidth', linewidth);
plot(errors_h3{4}, 'color', [colours_h3(4,:)], 'linewidth', linewidth);
