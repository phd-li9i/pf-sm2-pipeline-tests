...
for m = 1:size(maps,2)
  ...
  if strcmp(map, 'corridor')
    ...
    set(gca, 'xtick', [4 6 8 10 12 14], 'xticklabel', {'$4$','$6$','$8$','$10$','$12$','$14$'});
    set(gca, 'ytick', [4 6 8 10 12 14], 'yticklabel', {'$4$','$6$','$8$','$10$','$12$','$14$'});
  endif

  if strcmp(map, 'warehouse_karto')
    set(h,'position',[1 1 200 250]);
    set(gca, 'xtick', [0 5 10 15 20], 'xticklabel', {'$0$','$5$','$10$','$15$','$20$'});
    set(gca, 'ytick', [0 5 10 15 20 25 30 35 40], 'yticklabel', {'$0$','$5$','$10$','$15$','$20$','$25$','$30$','$35$','$40$'});
  endif

  if (store == 1)
    img_file = strcat('/home/li9i/catkin_ws/src/pipeline_evaluator/experiments/scripts_phd/maps/', map, '.eps');
