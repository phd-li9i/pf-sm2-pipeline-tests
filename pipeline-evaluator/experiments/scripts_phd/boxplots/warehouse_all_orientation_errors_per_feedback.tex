...
\begingroup
  ...
  \begin{picture}(10000.00,4000.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \colorrgb{0.00,0.00,0.00}%
      \put(2927,4029){\makebox(0,0){\strut{}Κατανομή σφαλμάτων εκτίμησης προανατολισμού ανά μέθοδο ανάδρασης [rad]}}%
    }%
    ...
    \gplbacktext
    \put(0,0){\includegraphics{/home/li9i/catkin_ws/src/pipeline_evaluator/experiments/scripts_phd/boxplots/warehouse_all_orientation_errors_per_feedback}}%
    \gplfronttext
  \end{picture}%
\endgroup
